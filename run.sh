...
iname=${DOCKER_IMAGE:-"learning_humanoid_walking:ubuntu24.04"} ##
cname=${DOCKER_CONTAINER:-"learning_humanoid_walking"} ## name of container (should be same as in exec.sh)
